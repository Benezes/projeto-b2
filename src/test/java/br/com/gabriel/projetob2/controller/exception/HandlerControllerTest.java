...
class HandlerControllerTest {
    ...
    HttpServletRequest r = createHttpServletRequest();
    @InjectMocks
    ...
    @Test
    void parcelamentoError() {
        ResponseEntity<StandardError> result = handlerController.parcelamentoError(new InstallmentsException("test"), r);
        assertNotNull(result);
    }

    @Test
    void apiError() {
        ResponseEntity<StandardError> result = handlerController.apiError(new CallFailedException("test"), r);
        assertNotNull(result);
    }

    @Test
    void jsonParserError() {
        ResponseEntity<StandardError> result = handlerController.jsonParserError(new JsonFormatException("test"), r);
        assertNotNull(result);
    }
